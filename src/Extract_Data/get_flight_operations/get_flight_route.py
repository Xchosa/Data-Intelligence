...
#/operations/flightstatus/route/{origin}/{destination}/{date}?serviceType={serviceType}

def get_data_flight_route(
    base_Url: str,
    ...
    operations = f"/v1/{operations}/{operation_type}/{operation_subtype}/{origin}/{destination}/{Date}?serviceType={serviceType}"
    dummy_count = 0
    ...
    while True:
        ...
        try:
            ...
            if utilis.processing_Error(json_data, meta_data_key):
                # server_error == 5 insstead of proxy error 
